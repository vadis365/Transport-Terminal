...
public class TransportTerminalCrafting {
	...
	public static void addRecipes() {
		...
		ItemStack nbtPlayerChip = new ItemStack(TransportTerminal.transportTerminalPlayerChip, 1);
		...
		GameRegistry.addShapelessRecipe(nbtPlayerChip, new Object[] { Items.name_tag, Items.diamond, TransportTerminal.transportTerminalChip });
	}
}