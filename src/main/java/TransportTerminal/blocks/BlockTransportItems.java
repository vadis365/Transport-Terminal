...
public class BlockTransportItems extends BlockContainer {
	
	@SideOnly(Side.CLIENT)
	private IIcon sides;
	
	public BlockTransportItems() {
		super(Material.iron);
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityTransportItems();
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		if (tile != null && tile instanceof TileEntityTransportItems) {
			...
			player.openGui(TransportTerminal.instance, TransportTerminal.proxy.GUI_ID_ITEMS, world, x, y, z);
		}
		return true;
	}
	...
	public void registerBlockIcons(IIconRegister reg) {
		blockIcon = reg.registerIcon("transportterminal:transportItemsFront");
		sides = reg.registerIcon("transportterminal:transportItemsSides");
	}
}
