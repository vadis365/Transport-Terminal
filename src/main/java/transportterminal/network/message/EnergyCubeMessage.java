...
public class EnergyCubeMessage implements IMessage {

	public int dimension, entityID, buttonID;
	public BlockPos tilePos;

	public EnergyCubeMessage() {
	}

	public EnergyCubeMessage(EntityPlayer player, int button, BlockPos pos) {
	...
	public EnergyCubeMessage(EntityPlayer player, int button, int x, int y, int z) {
		dimension = player.dimension;
		entityID = player.getEntityId();
		buttonID = button;
