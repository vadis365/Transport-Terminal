...
public class GuiRemoteQuantumCrate extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int x, int y) {
		...
		fontRenderer.drawString(I18n.format("Quantum Crate Location X: " + xx + " Y: " + yy + " Z: " + zz), 12, 4, 4210752);
		fontRenderer.drawString(I18n.format("container.inventory"), 48, ySize - 96, 4210752);
		fontRenderer.drawString(I18n.format("RF: " + ((IEnergyContainerItem) stack.getItem()).getEnergyStored(stack)), 156, ySize - 96, 4210752);
	}
